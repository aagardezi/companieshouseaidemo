...
market_query20_tool = types.Tool(
    function_declarations=[
        ...
        geminitoolcompanieshouse.search_companies,
        geminitoolcompanieshouse.get_company_profile,
        geminitoolcompanieshouse.get_company_officers,
        geminitoolcompanieshouse.get_company_filing_history,
    ],
)
